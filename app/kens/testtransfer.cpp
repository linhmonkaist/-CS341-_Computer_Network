...
TEST_F(TestEnv_Any, TestTransfer_Connect_Send_Symmetric) {
  ...
  connect_env["LOOP_COUNT"] = "2"; //origin 128
  connect_env["SENDER"] = "1";
  connect_env["EXPECT_SIZE"] = "2048"; //origin 131072
  int client_pid =
      host1->addApplication<TestTransfer_Connect>(*host1, connect_env);

  accept_env["SENDER"] = "0";
  accept_env["BUFFER_SIZE"] = "1024";
  accept_env["LOOP_COUNT"] = "2"; //origin 128
  accept_env["EXPECT_SIZE"] = "2048"; //origin 131702
  int server_pid =
